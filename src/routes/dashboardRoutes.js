...
router.put('/users/:userId', protect, authorize('admin'), dashboardController.updateUser);
router.delete('/users/:userId', protect, authorize('admin'), dashboardController.deleteUser);
